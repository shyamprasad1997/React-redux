    ...
    render(){
        ...
        <div className="Form">
            ...
            <form onSubmit={this.submit.bind(this)} >
                <input placeholder="Name" name="name" value={this.state.name} onChange={this.handleChange.bind(this)} required/>
                <br></br>
                <input type ="email" placeholder="Email" name="email"
                    value={this.state.email} onChange={this.handleChange.bind(this)} 
                    required/>
                <br></br>
                <textarea placeholder="Feedback" name="feed" value={this.state.feed} onChange={this.handleChange.bind(this)} required/>
                <br></br>
                <input className="button" type="submit" value="Submit"/>
                <input name ="test" type="button" className="button" onClick= {this.toggle.bind(this)} value="Cancel"/>
            </form>
            </center>
        </div>
        )
